# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-13 17:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Label',
            fields=[
                ('id', models.CharField(max_length=50, primary_key=True, serialize=False, unique=True, verbose_name='Label')),
            ],
        ),
        migrations.CreateModel(
            name='Mailbox',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plaintext', models.TextField(blank=True, default='', verbose_name='Text')),
                ...
                ('labels', models.ManyToManyField(related_name='messages', related_query_name='message', to='django_mailbox.Label')),
